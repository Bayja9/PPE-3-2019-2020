...
$sql = "SELECT ville_nom_reel, ville_code_postal FROM villes_france_free WHERE ville_code_postal LIKE (:keyword) ORDER BY ville_code_postal ASC";  // création de la requete avec sélection des résultats sur la lettre
