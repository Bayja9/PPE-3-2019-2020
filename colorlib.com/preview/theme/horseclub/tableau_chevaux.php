...
<html lang="fr">
    ...
    <center>
      ...
      <table border="8" cellpadding="5" cellspacing="2" width="50%" >
       <tr>
        ...
        <p class="">
          ...
          <th align="center" width="1%" style="color:#C40101">Nom des Chevaux</th>
          <th align="center" width="1%" style="color:#C40101">Date de Naissance des Chevaux</th>
          <th align="center" width="1%" style="color:#C40101">Taille des Chevaux</th>
          <th align="center" width="1%" style="color:#C40101">Couleur des Chevaux</th>
          <th align="center" width="1%" style="color:#C40101">Note des Chevaux</th>
      ...
      while($ligne=$result->fetch())
       ...
       ?>
          <tr>
             <td align="center" width="1%" style="color:black"><b><?php echo $ligne['id_chevaux']?></b></td>
             <td align="center" width="1%" style="color:black"><b><?php echo $ligne['nom_chevaux']?></b></td>
             <td align="center" width="24%" style="color:black"><b><?php echo $ligne['dna_chevaux']?></b></td>
