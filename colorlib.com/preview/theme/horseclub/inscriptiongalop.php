...
<form>
    ...
    <div class="inner-wrap">
        <label><input type="text" name="field1" placeholder="Nom du Galop" /></label>
        <label><input type="text" name="field2" placeholder="Libellé Galop" /></label>
    </div>
    <hr>
    <div class="section"><span>1</span>Autres</div>
    <div class="inner-wrap">
      <label>date obtention<input type="date" name="field3" /></label>
    <hr>
    ...
    <div class="button-group-area mt-40">
						<a href="#" class="genric-btn danger radius">Valider le Galop</a>
            <br><br><br>  <br><br><br>
		</div>
</form>
</div>
