      ...
      while($ligne=$result->fetch())
       ...
       ?>
          <tr>
             ...
             <td align="center" width="1%" style="color:black"><a href=modif_stage.php?id_stage=<?php echo $ligne['id_stage']?> </a><img src='http://www.radiolavoiesainte.net/neriyatv/images/modifier.jpg' width='50px' height='50px'  alt='le alt'</td>
             <td align="center" width="1%" style="color:black"><a href=modif_stage.php?id_stage=<?php echo $ligne['id_stage']?> </a><img src='https://cdn.pixabay.com/photo/2013/07/12/12/40/abort-146072_960_720.png' width='50px' height='50px' alt='le alt'</td>
          </tr>
          <?php
        }
           ?>
