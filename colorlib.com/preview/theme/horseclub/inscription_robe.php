      ...
      <div class="container">
        <div class="row d-flex align-items-center justify-content-center">
          <div class="about-content col-lg-12">
            ...
            <p class="text-white link-nav"><a href="index.php">Accueil </a>  <span class="lnr lnr-arrow-right"></span>  <a href="inscription_terrain.php">inscription Robe</a></p>
          </div>
        </div>
      </div>
    </section>
...
<center>
    <div class="form-style-10">
      <br><br>
<h1>Inscription Terrain<span>Inscrivez-vous pour cette robe</span></h1>
<form action='operation_robe.php' method='post'>
  <div class="section"><span>1</span>Information sur La Robe</div>
  <div class="inner-wrap">
    <textarea class="form-control" name="couleur" rows="1" cols="80" placeholder="Couleur"/></textarea>
  <hr>
</div>
  <div class="button-group-area mt-40">
    <input type="submit" class="genric-btn danger radius" name="enregistrero" value="Enregistrer">
    <br><br>
    <a class="primary-btn" href="modif_galop.php">Modification robe</a> <a class="primary-btn" href="suppr_galop.php">Suppression robe</a>
  </div>
